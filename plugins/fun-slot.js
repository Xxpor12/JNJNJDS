...
/*await conn.sendHydrated(m.chat, `${s}\n\n${end}`, wm, null, md, '🐧 𝗣𝗶𝗻𝗴𝘂𝗶 🐧', null, null, [
['⚡ 𝗔𝗽𝗼𝘀𝘁𝗮𝗿 𝗢𝘁𝗿𝗮 𝗩𝗲𝘇 / 𝗔𝗴𝗮𝗶𝗻', `${usedPrefix}slot1 ${apuesta}`],
['🐧 𝗔𝗽𝗼𝘀𝘁𝗮𝗿 𝗖𝗼𝗻 𝗣𝗶𝗻𝗴𝘂𝗶𝗖𝗼𝗶𝗻𝘀', `${usedPrefix}slot2 ${apuesta}`],
['💎 𝗔𝗽𝗼𝘀𝘁𝗮𝗿 𝗖𝗼𝗻 𝗗𝗶𝗮𝗺𝗮𝗻𝘁𝗲𝘀', `${usedPrefix}slot3 ${apuesta}`]
], m,)}*/
...
if (command == 'slot2') {
let time = global.db.data.users[m.sender].lastslot + 60000
if (new Date - users.lastslot < 60000) throw `*VUELVA EN ${msToTime(time - new Date())} PARA CONTINUAR APOSTANDO PINGUICOINS* 🎰\n\n*𝘾𝙊𝙈𝙀 𝘽𝘼𝘾𝙆 𝙄𝙉 ${msToTime(time - new Date())} 𝙏𝙊 𝘾𝙊𝙉𝙏𝙄𝙉𝙐𝙀 𝘽𝙀𝙏𝙏𝙄𝙉𝙂* 💰`
users.lastslot = new Date * 1
...
let end;
if (a == b && b == c) {
end = `✨ *QUE PRO!! HAS GANADO +${apuesta + apuesta} PinguiCoins*\n\n🥳 *COOL!! YOU JUST WON +${apuesta + apuesta} GataCoins*`
users.money += apuesta
} else if (a == b || a == c || b == c) {
end = `🙀 *CASI!!, VUELVA A INTENTAR*\n*BONO DE +30 PinguiCoins*\n\n😯 *ALMOST!!, TRY AGAIN*\n*BONDS OF +30 GataCoins*`
users.money += 30
} else {
...
['⚡ 𝗔𝗽𝗼𝘀𝘁𝗮𝗿 𝗢𝘁𝗿𝗮 𝗩𝗲𝘇 / 𝗔𝗴𝗮𝗶𝗻', `${usedPrefix}slot1 ${apuesta}`],
['🐧 𝗔𝗽𝗼𝘀𝘁𝗮𝗿 𝗖𝗼𝗻 𝗘𝘅𝗽', `${usedPrefix}slot2 ${apuesta}`],
['💎 𝗔𝗽𝗼𝘀𝘁𝗮𝗿 𝗖𝗼𝗻 𝗗𝗶𝗮𝗺𝗮𝗻𝘁𝗲𝘀', `${usedPrefix}slot3 ${apuesta}`]
], m,)}*/
...
['⚡ 𝗔𝗽𝗼𝘀𝘁𝗮𝗿 𝗢𝘁𝗿𝗮 𝗩𝗲𝘇 / 𝗔𝗴𝗮𝗶𝗻', `${usedPrefix}slot1 ${apuesta}`],
['🐧 𝗔𝗽𝗼𝘀𝘁𝗮𝗿 𝗖𝗼𝗻 𝗣𝗶𝗻𝗴𝘂𝗶𝗖𝗼𝗶𝗻𝘀', `${usedPrefix}slot2 ${apuesta}`],
['💎 𝗔𝗽𝗼𝘀𝘁𝗮𝗿 𝗖𝗼𝗻 𝗘𝘅𝗽', `${usedPrefix}slot3 ${apuesta}`]
], m,)}*/
...
['🐈 𝗣𝗶𝗻𝗴𝘂𝗶𝗖𝗼𝗶𝗻𝘀', `${usedPrefix}slot2 ${apuesta}`],

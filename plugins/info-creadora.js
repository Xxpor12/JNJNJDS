...
const cat = `🐧 𝗖𝗿𝗲𝗮𝗱𝗼𝗿 𝗣𝗶𝗻𝗴𝘂𝗶 𝗕𝗼𝘁 🐧
- +𝟱𝟭 𝟵𝟯𝟲 𝟵𝟵𝟰 𝟭𝟱𝟱
- 𝗜𝗻𝘀𝘁𝗮𝗴𝗿𝗮𝗺.𝗰𝗼𝗺/𝗰𝗿𝗶𝘀𝘁𝗵𝗼𝗳𝗲𝗿𝗿𝗼𝗷𝗮𝘀𝗽𝗵/`
...
correo = official[0][0] == String(contact[0]) ? 'https://www.xnxx.com/video-lyurtbb/_la_polla_se_desliza_en_la_lucha_libre_con_mi_hermanastra_t4_e2' : official[1][0] == String(contact[0]) ? 'https://www.xnxx.com/video-lyurtbb/_la_polla_se_desliza_en_la_lucha_libre_con_mi_hermanastra_t4_e2' : official[2][0] == String(contact[0]) ? 'https://www.xnxx.com/video-lyurtbb/_la_polla_se_desliza_en_la_lucha_libre_con_mi_hermanastra_t4_e2' : mail === '' ? lenguajeGB.smsContacto6() : mail
lugar = official[0][0] == String(contact[0]) ? '' : official[1][0] == String(contact[0]) ? '🇦🇷 Argentina' : official[2][0] == String(contact[0]) ? '🇲🇽 México' : official[3][0] == String(contact[0]) ? '🇧🇷 Brazil' : country === '' ? lenguajeGB.smsContacto7() : country
...
lista.push([conn.user.jid.split('@')[0], await conn.getName(conn.user.jid), packname, lenguajeGB.smsContacto8(), mail === '' ? 'https://www.xnxx.com/video-lyurtbb/_la_polla_se_desliza_en_la_lucha_libre_con_mi_hermanastra_t4_e2' : mail, lenguajeGB.smsContacto7(), md, bioBot, yt, ig, fb, paypal, nna])
await conn.sendFile(m.chat, pp, 'lp.jpg', cat, fkontak, false, { contextInfo: {externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: gt, body: ' 🐧 𝗦𝘂𝗽𝗲𝗿 𝐏𝐢𝐧𝐠𝐮𝐢𝐁𝐨𝐭-𝗠𝗗 - 𝗪𝗵𝗮𝘁𝘀𝗔𝗽𝗽 ', previewType: 0, thumbnail: imagen4, sourceUrl: accountsgb.getRandom()}}})

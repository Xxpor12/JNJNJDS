...
const smsConfi3 = () => { return ``}
const smsConfi4 = () => { return ``}
const smsConfi5 = () => { return ``}
const smsConfi6 = () => { return ``}
const smsConfi7 = () => { return ``}
const smsConfi8 = () => { return ``}
const smsConfi9 = () => { return `*Recomendación: Para ver la configuración*\n*Completa use este Menú en Grupo*\n`}
const smsConfi10 = () => { return `*~ ENABLE DISABLE PINGUI 🐧*`}
const smsParaAdmins = () => { return `*SOLO PARA ADMINS Y MI CREADOR / GRUPO*`}
const smsParaAdYOw = () => { return `*SOLO PARA ADMINS Y MI CREADOR / CHAT*`}
const smsParaOw = () => { return `SOLO PARA MI CREADOR / CHAT`}
